...
public interface IDotNetCakeRunner {
    ...
    /// <summary>
    /// Run cake script in a specified folder, optionally with diagnostics, return errors
    /// </summary>
    /// <param name="scriptFileFullName"></param>
    /// <param name="diagnostics"></param>
    /// <param name="errorsAndInfos"></param>
    void CallCake(string scriptFileFullName, bool diagnostics, IErrorsAndInfos errorsAndInfos);
    ...
    /// <summary>
    /// Run cake script with a specific target in a specified folder, optionally with diagnostics, return errors
    /// </summary>
    /// <param name="scriptFileFullName"></param>
    /// <param name="target"></param>
    /// <param name="diagnostics"></param>
    /// <param name="errorsAndInfos"></param>
    void CallCake(string scriptFileFullName, string target, bool diagnostics, IErrorsAndInfos errorsAndInfos);
}